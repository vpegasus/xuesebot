...
class SearchDB(object):
    ...
    def node_search(self, ntype, count=None, all=None, limit=None, **kwargs):
        if count:
    ...
    def rel_get(self, id_):
        return self.rmatcher.get(id_)

    def rel_search(self, nd, rtype, **kwargs):
        if 'count' in kwargs:
    ...
    def person_attr(self, name, attr):
    ...
    def get_people_with_family_name(self, family_name):
        """
    ...
    def force_with_family_name(self, force, family_name):
        """
    ...
    def city_with_family_name(self, city, family_name, attr='pc_city_now_in'):
        """
        城池中姓 'family name' 的人
        :param city:
        :param family_name:
